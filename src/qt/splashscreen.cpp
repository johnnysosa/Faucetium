    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("FAUCETIUM Core");
    ...
    QString copyrightText3  = QChar(0xA9)+QString("2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The FAUCETIUM developers"));
    ...
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpace+24,copyrightText3);
