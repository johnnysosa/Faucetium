    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered bitcoin address / amount:
            ...
            if(termDepositLength>0){
                ...
                ss <<"This will send the amount of " << (0.0+rcp.amount)/COIN <<" FAUCET ";
                ...
                ss <<"Upon maturation, it will be worth " << (0.0+withInterest)/COIN << " FAUCET. ";
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        Q_FOREACH(const SendCoinsRecipient &rcp, transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal FAUCETIUM:URI (FAUCETIUM:123...?message=example)
