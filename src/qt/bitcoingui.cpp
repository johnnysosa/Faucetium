    ...
    miningOnAction(0)
{
    ...
    QString windowTitle = tr("FAUCETIUM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FAUCETIUM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and FAUCETIUM: URIs)"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About FAUCETIUM Core"), this);
    aboutAction->setStatusTip(tr("Show information about FAUCETIUM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FAUCETIUM Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FAUCETIUM addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FAUCETIUM addresses"));
    ...
    openAction->setStatusTip(tr("Open a FAUCETIUM: URI or payment request"));

    showHelpMessageAction = new QAction(TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FAUCETIUM Core help message to get a list with possible FAUCETIUM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FAUCETIUM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FAUCETIUM network", "", count));
}
...
{
    QString strTitle = tr("FAUCETIUM"); // default title
